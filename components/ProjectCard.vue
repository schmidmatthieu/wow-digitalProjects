        ...
        <div class="mt-6 space-y-4">
          <template v-if="project.environments.development">
            <div class="space-y-2">
              ...
              <div class="flex gap-2">
                <a
                  v-if="project.environments.development.frontend"
                  :href="project.environments.development.frontend"
                  target="_blank"
                ...
                <a
                  v-if="project.environments.development.backend"
                  :href="project.environments.development.backend"
                  target="_blank"
                  class="px-3 py-1.5 text-sm rounded-md bg-cyber-darker border border-neon-yellow/10 text-neon-yellow/80 hover:bg-neon-yellow/5 hover:border-neon-yellow/30 transition-all duration-200"
                >
                  Backoffice
          ...
          <template v-if="project.environments.staging">
            <div class="space-y-2">
              ...
              <div class="flex gap-2">
                <a
                  v-if="project.environments.staging.frontend"
                  :href="project.environments.staging.frontend"
                  target="_blank"
                ...
                <a
                  v-if="project.environments.staging.backend"
                  :href="project.environments.staging.backend"
                  target="_blank"
                  class="px-3 py-1.5 text-sm rounded-md bg-cyber-darker border border-neon-blue/10 text-neon-blue/80 hover:bg-neon-blue/5 hover:border-neon-blue/30 transition-all duration-200"
                >
                  Backoffice
          ...
          <template v-if="project.environments.production">
            <div class="space-y-2">
              ...
              <div class="flex gap-2">
                <a
                  v-if="project.environments.production.frontend"
                  :href="project.environments.production.frontend"
                  target="_blank"
                ...
                <a
                  v-if="project.environments.production.backend"
                  :href="project.environments.production.backend"
                  target="_blank"
                  class="px-3 py-1.5 text-sm rounded-md bg-cyber-darker border border-neon-pink/10 text-neon-pink/80 hover:bg-neon-pink/5 hover:border-neon-pink/30 transition-all duration-200"
                >
                  Backoffice
          ...
          <template v-if="project.environments.figma">
            <div class="space-y-2">
              ...
              <div class="flex gap-2">
                <a
                  :href="project.environments.figma"
                  target="_blank"
